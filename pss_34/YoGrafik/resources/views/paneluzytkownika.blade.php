                            ...
                            <div class="col-md-12">
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="name" name="name" placeholder="{{old('name')}}" class="form-control here" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="name" class="col-4 col-form-label">* Nazwisko:</label>
                                        <div class="col-8">
                                            <input id="surname" name="surname" placeholder="{{old('surname')}}" class="form-control here" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email" class="col-4 col-form-label">* Adres email:</label>
                                        <div class="col-8">
                                            <input id="email" name="email" placeholder="{{old('email')}}" class="form-control here" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="text" class="col-4 col-form-label">Telefon: </label>
                                        <div class="col-8">
                                            <input id="phone" name="phone" placeholder="{{old('phone')}}" class="form-control here" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <textarea id="description" name="description" placeholder="{{old('description')}}" cols="40" rows="4" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
